 ...
 *
 */
public class MarketMtgoxHistory extends MarketMtgox{

	private HistoryData histData;
	
	public MarketMtgoxHistory(Currency cur1, Currency cur2, Wallet wallet,String filename) throws ExchangeError {
		super(cur1, cur2);
